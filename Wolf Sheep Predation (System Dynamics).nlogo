...
to-report wolf-min-pop?
  let min-pop wolves
  if min-pop < wolves [let min-pop wolves]
  report min-pop
end

to-report wolf-max-pop?

end

to-report sheep-min-pop?

end

to-report sheep-max-pop?
...
0.5
    org.nlogo.sdm.gui.AggregateDrawing 25
        ...
        org.nlogo.sdm.gui.StockFigure "attributes" "attributes" 1 "FillColor" "Color" 225 225 175 279 275 60 40
            org.nlogo.sdm.gui.WrappedStock "wolves" "40" 1
        ...
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 120 188 182 233 175 50 50
            org.nlogo.sdm.gui.WrappedConverter ".001" "predation-rate"
